...
# 获取数据
origin_data = pd.read_csv(r'Python\\DataAnalysis\\SpotifyFeatures(finalcleaned).csv', encoding='gbk')
...
# 通过多种模型预测
model_svr1 = SVR(kernel='rbf',C=50,max_iter=1000)
