...
url1 = pd.read_csv(r'Python\\DataAnalysis\\SpotifyFeatures(finalcleaned).csv', encoding='gbk')
# url1 = pd.DataFrame(url1)
# df = pd.read_csv(url1,header=None)
url1.columns = ['genre','popularity','acousticness','danceability','energy','instrumentalness',
